...
## Project Structure
    ...
    ├── testapiautocatalog_113033  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_113033`
...
2. Clone this repo and `cd testapiautocatalog_113033`
